...
func setupRequestResponse(c *context.Context, r *router.Router) rsocket.OptAbstractSocket {
...
func setupRequestStream(c *context.Context, router *router.Router) rsocket.OptAbstractSocket {
...
func setupRequestChannel(c *context.Context, router *router.Router, buffSize int) rsocket.OptAbstractSocket {
