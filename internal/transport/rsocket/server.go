		...
		Acceptor(
			func(
				...
				return rsocket.NewAbstractSocket(
					setupRequestResponse(c, route),
					setupRequestStream(c, route),
					setupRequestChannel(c, route, r.buffSize),
				), nil
			},
		)
}
...
func setupRequestResponse(cc *context.Context, r *router.Router) rsocket.OptAbstractSocket {
...
func setupRequestStream(cc *context.Context, router *router.Router) rsocket.OptAbstractSocket {
...
func setupRequestChannel(cc *context.Context, router *router.Router, buffSize int) rsocket.OptAbstractSocket {
