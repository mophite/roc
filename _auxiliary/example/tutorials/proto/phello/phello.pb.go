...
var fileDescriptor_b68df64f33d13f32 = []byte{
	...
	,
}
...
func (m *SayReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Inc != 0 {
		i = encodeVarintPhello(dAtA, i, uint64(m.Inc))
		i--
		dAtA[i] = 0x8
	}
...
func (r *helloWorldHandler) Say(c *roc.Context, req *parcel.RocPacket, interrupt parcel.Interceptor) (rsp proto.Message, err error) {
	var in SayReq
