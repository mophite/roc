...
type HelloClient interface {
	Say(c *context.Context, req *SayReq, opts ...invoke.InvokeOptions) (chan *SayRsp, chan error)
	Roc(c *context.Context, req *RocReq, opts ...invoke.InvokeOptions) (chan *RocRsp, chan error)
}
...
func (cc *helloClient) Say(c *context.Context, req *SayReq, opts ...invoke.InvokeOptions) (chan *SayRsp, chan error) {
...
func (cc *helloClient) Roc(c *context.Context, req *RocReq, opts ...invoke.InvokeOptions) (chan *RocRsp, chan error) {
